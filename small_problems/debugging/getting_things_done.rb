...
# a system stack  error is a sort of infinite loop that occurs when a  method calls itself to infinity. It happens when there is no base case, which serves to stop the recursion.
